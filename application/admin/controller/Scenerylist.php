...
class Scenerylist extends Admin
{
    /**
     * 显示资源列表
     *
    ...
    {
        $list = Db::table('ml_scenery')->select();
...
// 上传失败获取错误信息
    ...
    public function read($id)
    {
        ...
        return view('scenery/adminlistDetail');
